// ==UserScript==
// @name         Slither.io-bot 0.1.0 / slither.io
// @namespace    http://slither.io/
// @version      0.1.0
// @description  Slither.io bot 0.1.0 / slither.io
// @author       Andrew Borrud
...
(function() {
    ...
    window.nick.value = userInterface.loadPreference('savedNick', 'Ayy Lmao');
    ...
    window.startInterval = setInterval(bot.startBot, 1000);
        ...
        if (login) {
            ...
            stmenu.innerHTML = "Author:";
            login.appendChild(stmenu);
            stmenu.appendChild(div);
			stmenu.innerHTML += 'Andrew Borrud'; 
    }
	}
	setMenu();
})();